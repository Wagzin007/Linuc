...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("~/.config/linuc-scripts/kitty-safe.sh"))
...
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("~/.config/linuc-scripts/kitty-safe.sh --class linuc-ctl -e ~/.config/linuc-scripts/linuc-ctl.sh"))
...
-- workspaces 1-10
for i = 1, 10 do
  local key = i % 10 -- 10 vira a tecla 0
  hl.bind(mainMod .. " + " .. key, hl.dsp.focus({ workspace = i }))
  hl.bind(mainMod .. " + SHIFT + " .. key, hl.dsp.window.move({ workspace = i }))
end

-- scroll pra trocar workspace
